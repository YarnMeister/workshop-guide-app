...
4. Make any adjustments or refinements as needed`
      ...
      educationPanel: {
        title: "How We Enhanced Your Prompt",
        description: "Behind the scenes, we used ChatGPT 3.5 to transform your PRD into a Lovable-optimized prompt. Below are the exact instructions we sent to the AI agent, depending on whether you chose to use property data or not.",
        tabs: [
          {
            title: "Standard Prompt",
            description: "Instructions used when NOT using property data",
            content: `You are an expert at transforming product requirements into clear, actionable prompts for Lovable (an AI-powered web app builder).
...
Now transform the mini PRD into a polished Lovable prompt.`
          ...
          {
            title: "Property Data Prompt",
            description: "Instructions used when using Australian property data",
            content: `You are an expert at transforming product requirements into clear, actionable prompts for Lovable (an AI-powered web app builder).
